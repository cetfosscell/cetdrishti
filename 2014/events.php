...
?>
<?php	if($event->id==51){?>		
<a class="sub_form" href="http://cetdrishti.com/pdf/creovate.pdf" target="_blank" style="position:absolute;bottom:10px;right:10px;">Submission Format</a><?php } ?>
<div id="modal-content">
	...
	<p class="modal-p1"><b>Total Prize&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <?php
...
<?php	if($event->group==7 || $event->id==26){?>		<li><a data-ref="#tabs-4" title="">Problem Statement</a></li>
					
	<?php }?>	
	
		<li><a data-ref="#tabs-2" title="">Rules</a></li>
