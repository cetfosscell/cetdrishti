	...
	<div class="container">
		<div class="masthead">
			<ul class="nav nav-pills pull-right">
				...
				<li><a href="sudo/upedit">Edit question</a></li>
			</ul>
		...
		<div class="row">
			...
			<?php echo Form::open_for_files('sudo/upload', 'POST', array('class' =>'form-horizontal span7 upload_q' , )); ?>

				<h3>Add question no: {{$total+1}}</h3>
				...
				<div class="control-group">
					<label class="control-label" for="hash">Hahstag</label>
					<div class="controls">
			...
			{{Form::close()}}
				...
				<span class="msg_usr"><span class="icon-user"></span>Users : {{$no_user}}</span>
